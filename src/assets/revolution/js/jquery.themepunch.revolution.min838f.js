    ...
    setSize: function (e) {
      ...
      if (
        ...
        "fullwidth" == e.sliderLayout &&
          "off" == e.autoHeight &&
          punchgs.TweenLite.set(e.c, { maxHeight: a + "px" }),
        e.c.css({ marginTop: i, marginBottom: n }),
        (e.width = e.ul.width()),
  ...
  var _ISM = _R.is_mobile(),
    ...
    runSlider = function (e, t) {
      ...
      if (
        ...
        "fullwidth" == t.sliderLayout &&
          "off" == t.autoHeight &&
          e.css({ maxHeight: t.gridheight[t.curWinRange] + "px" }),
        "auto" != t.sliderLayout &&
      ...
      if (
        ...
        (t.inviewport = !1),
          v != undefined &&
            v.enable &&
            (jQuery.isNumeric(v.visible_area) ||
              (-1 !== v.visible_area.indexOf("%") &&
                (v.visible_area = parseInt(v.visible_area) / 100)),
            _R.scrollTicker && _R.scrollTicker(t, e)),
          setTimeout(function () {
            "carousel" == t.sliderType && _R.prepareCarousel(t),
              !v.enable ||
              (v.enable && t.inviewport) ||
              (v.enable && !t.inviewport && "wait" == !v.outof)
                ? swapSlide(e, t)
                : (t.waitForFirstSlide = !0),
              _R.manageNavigation && _R.manageNavigation(t),
              t.slideamount > 1 &&
                (!v.enable || (v.enable && t.inviewport)
                  ? countDown(e, t)
        ...
        jQuery(window).on(m, function () {
          return e == undefined
            ...
            : (0 != jQuery("body").find(e) && contWidthManager(t),
              void (
                (e.outerWidth(!0) != t.width ||
                  e.is(":hidden") ||
                  ("fullscreen" == t.sliderLayout &&
                    jQuery(window).height() != t.lastwindowheight)) &&
    ...
    contWidthManager = function (e) {
      ...
      e.slayers &&
        ...
        punchgs.TweenLite.set(e.slayers, { left: t });
    },
    cv = function (e, t) {
      ...
      jQuery(window).width() < t.hideSliderAtLimit
        ...
        : e.is(":hidden") &&
          ...
          "none" != n.data("olddisplay")
            ? n.css({ display: n.data("olddisplay") })
            : n.css({ display: "block" }),
      ...
      if (
        ...
        removeSlots(e, t, e, 2),
          "standard" === t.sliderType &&
            (punchgs.TweenLite.set(n.find(".defaultimg"), { opacity: 0 }),
      ...
      e.find("img,.defaultimg, .tp-svg-layer").each(function () {
          ...
          if ((i.attr("src", r.src), "img" == r.type))
            if (i.hasClass("defaultimg"))
              _R.isIE(8)
                ...
                : i.css({ backgroundImage: 'url("' + r.src + '")' }),
        ...
        if (
          (r &&
            ...
            (jQuery.now() - i.data("start-to-load") < 5e3
              ? (n = !0)
              : ((r.progress = "failed"),
    ...
    swapSlideProgress = function (e, t, i) {
      ...
      (e.tonpause = !1),
        (e.cd = 0),
        i.find(".tp-loader").css({ display: "none" }),
        _R.setSize(e),
        _R.slotSize(t, e),
      ...
      if ("carousel" == e.sliderType)
        ...
        (c = new punchgs.TimelineLite({
          ...
          c.add(punchgs.TweenLite.set(o.find(".defaultimg"), { opacity: 0 })),
          c.pause(),
          1 == e.firststart &&
            (punchgs.TweenLite.set(n, { autoAlpha: 0 }), (e.firststart = 0)),
        ...
        e.ie &&
          ...
          "on" == o.data("kenburns") &&
            (_R.startKenBurn(o, e),
            c.add(punchgs.TweenLite.set(o, { autoAlpha: 0 }))),
          c.pause();
      }
      _R.scrollHandling &&
